...
Route::prefix('v1')->group(function () {
    ...
    // User-specific routes with admin-only access
        Route::get('/users/roles-permissions', [UserController::class, 'rolesAndPermission'])->middleware([
        ...
        ;
        Route::get('/users/{user}', [UserController::class, 'show'])->name('users.show')->middleware([
